...
public abstract class UIButton extends UIPanel {
	public UIButton(float[] position, float width, float height, String texturePath) {
	...
	public void updateView() {
		if (sceneNodes.isEmpty()) {
			...
			sceneNodes.put(texturePath + "_UIPanelSceneNode", new UISceneNode(shaderProgram, objData, position, width, height));
		}
	}
}
