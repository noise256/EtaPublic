...
public class Planet extends Celestial {
	...
	public Planet(GameObject parent, float[] position, float[] rotation, float[] zDepths, int diameter, String[] texturePaths, int[] textureSizes, String name, SolarSystem solarSystem, ArrayList<FertilityType> fertilities) {
		super(parent, position, rotation, zDepths, diameter, texturePaths, textureSizes, name);
	...
	public void updateView() {
		if (sceneNodes.isEmpty()) {
			...
			VBOSceneNode selectionSceneNode = new VBOSceneNode(shaderProgram, objData, getPosition(), 0.0f, ZDepth.SELECTION.getDepth(), GL3bc.GL_TRIANGLES);
