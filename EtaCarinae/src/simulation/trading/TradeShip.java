...
public class TradeShip extends Ship implements Agent {
	...
	public TradeShip(float[] position, float[] rotation, float[] zDepths, int diameter, String[] texturePaths, int[] textureSizes, float[] velocity,PhysicalProfile physicalSpecification, ShipProfile shipSpecification, TradeCompany tradeCompany) {
		super(position, rotation, zDepths, diameter, texturePaths, textureSizes, velocity, physicalSpecification, shipSpecification);
	}
